...
class ipc_connection : public boost::enable_shared_from_this<ipc_connection>
{
public:
    ...
    static boost::shared_ptr<ipc_connection> create(boost::asio::io_service&); //Create shred_ptr object
...
private:
    ...
    ipc_connection(boost::asio::io_service& io_service) : socket_(io_service){
...
typedef boost::shared_ptr<ipc_connection> pointer;
#endif